...
export const INVINCIBILITY_DURATION = 10000; // 10 seconds in milliseconds
export const INVINCIBILITY_KEY = 'KeyI'; // I key for toggling invincibility
export const INVINCIBILITY_COLOR = '#FFD700'; // Golden color when invincible
