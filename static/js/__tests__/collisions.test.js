...
describe('handlePlayerAICollisions', () => {
    ...
    test('larger player cell consumes AI', () => {
        ...
        const ai = { x: 100, y: 100, score: 100, name: 'Test', color: '#fff', direction: 0 };
    ...
    test('larger AI consumes player cell', () => {
        ...
        const ai = { x: 100, y: 100, score: 400, name: 'Test', color: '#fff', direction: 0 };
        gameState.playerCells = [playerCell];
        gameState.aiPlayers = [ai];
        handlePlayerAICollisions();
...
describe('handleAIAICollisions', () => {
    ...
    test('larger AI consumes smaller AI', () => {
        const ai1 = { x: 100, y: 100, score: 400, name: 'Test1', color: '#fff', direction: 0 };
        const ai2 = { x: 100, y: 100, score: 100, name: 'Test2', color: '#fff', direction: 0 };
    ...
    test('equal sized AIs do not consume each other', () => {
        const ai1 = { x: 100, y: 100, score: 100, name: 'Test1', color: '#fff', direction: 0 };
        const ai2 = { x: 100, y: 100, score: 100, name: 'Test2', color: '#fff', direction: 0 };
        gameState.aiPlayers = [ai1, ai2];
        handleAIAICollisions();
...
//# sourceMappingURL=collisions.test.js.map