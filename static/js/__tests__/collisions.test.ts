...
import { Cell, AIPlayer, Food } from '../types.js';
...
describe('handlePlayerAICollisions', () => {
  ...
  test('larger player cell consumes AI', () => {
    const playerCell: Cell = { x: 100, y: 100, score: 400, velocityX: 0, velocityY: 0 };
    const ai: AIPlayer = { x: 100, y: 100, score: 100, name: 'Test', color: '#fff', direction: 0 };
  ...
  test('larger AI consumes player cell', () => {
    const playerCell: Cell = { x: 100, y: 100, score: 100, velocityX: 0, velocityY: 0 };
    const ai: AIPlayer = { x: 100, y: 100, score: 400, name: 'Test', color: '#fff', direction: 0 };
...
describe('handleAIAICollisions', () => {
  ...
  test('larger AI consumes smaller AI', () => {
    const ai1: AIPlayer = { x: 100, y: 100, score: 400, name: 'Test1', color: '#fff', direction: 0 };
    const ai2: AIPlayer = { x: 100, y: 100, score: 100, name: 'Test2', color: '#fff', direction: 0 };
  ...
  test('equal sized AIs do not consume each other', () => {
    const ai1: AIPlayer = { x: 100, y: 100, score: 100, name: 'Test1', color: '#fff', direction: 0 };
    const ai2: AIPlayer = { x: 100, y: 100, score: 100, name: 'Test2', color: '#fff', direction: 0 };
